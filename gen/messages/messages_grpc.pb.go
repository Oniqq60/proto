...
const (
	...
	MessageService_GetMessages_FullMethodName = "/messages.MessageService/GetMessages"
)
...
func (c *messageServiceClient) GetMessages(ctx context.Context, in *GetMessagesRequest, opts ...grpc.CallOption) (*MessagesList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedMessageServiceServer) GetMessages(context.Context, *GetMessagesRequest) (*MessagesList, error) {
