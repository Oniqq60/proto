...
const (
	...
	ChannelService_GetChannels_FullMethodName   = "/channels.ChannelService/GetChannels"
)
...
type ChannelServiceClient interface {
	...
	GetChannels(ctx context.Context, in *GetChannelsRequest, opts ...grpc.CallOption) (*ChannelsList, error)
}
...
func (c *channelServiceClient) GetChannels(ctx context.Context, in *GetChannelsRequest, opts ...grpc.CallOption) (*ChannelsList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ChannelsList)
...
type ChannelServiceServer interface {
	...
	GetChannels(context.Context, *GetChannelsRequest) (*ChannelsList, error)
...
func (UnimplementedChannelServiceServer) GetChannels(context.Context, *GetChannelsRequest) (*ChannelsList, error) {
...
var ChannelService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "channels/channels.proto",
}
